...
public class DatumEnvelope_old extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Creates a new DatumEnvelope_old RecordBuilder */
  public static com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder newBuilder() {
    return new com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder();
  }
  
  /** Creates a new DatumEnvelope_old RecordBuilder by copying an existing Builder */
  public static com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder newBuilder(com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder other) {
    return new com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder(other);
  }
  
  /** Creates a new DatumEnvelope_old RecordBuilder by copying an existing DatumEnvelope_old instance */
  public static com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder newBuilder(com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old other) {
    return new com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder(other);
  }
  
  /**
   * RecordBuilder for DatumEnvelope_old instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DatumEnvelope_old>
    implements org.apache.avro.data.RecordBuilder<DatumEnvelope_old> {
    ...
    private Builder() {
      super(com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing DatumEnvelope_old instance */
    private Builder(com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old other) {
            super(com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.SCHEMA$);
      if (isValidValue(fields()[0], other.datum_type_id)) {
        this.datum_type_id = data().deepCopy(fields()[0].schema(), other.datum_type_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'datum_type_id' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setDatumTypeId(java.lang.CharSequence value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearDatumTypeId() {
      datum_type_id = null;
    ...
    /** Sets the value of the 'datum_schema_version' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setDatumSchemaVersion(int value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearDatumSchemaVersion() {
    ...
    /** Sets the value of the 'logical_timestamp' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setLogicalTimestamp(long value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearLogicalTimestamp() {
    ...
    /** Sets the value of the 'incarnation' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setIncarnation(int value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearIncarnation() {
    ...
    /** Sets the value of the 'source_host' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setSourceHost(java.lang.CharSequence value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearSourceHost() {
      source_host = null;
    ...
    /** Sets the value of the 'creation_time' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setCreationTime(long value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearCreationTime() {
    ...
    /** Sets the value of the 'datumBytes' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setDatumBytes(java.nio.ByteBuffer value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearDatumBytes() {
      datumBytes = null;
    ...
    /** Sets the value of the 'serDeType' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setSerDeType(java.lang.CharSequence value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearSerDeType() {
      serDeType = null;
    ...
    /** Sets the value of the 'datumKey' field */
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder setDatumKey(java.lang.CharSequence value) {
    ...
    public com.outbrain.aletheia.datum.envelope.avro.DatumEnvelope_old.Builder clearDatumKey() {
      datumKey = null;
    ...
    @Override
    public DatumEnvelope_old build() {
      try {
        DatumEnvelope_old record = new DatumEnvelope_old();
