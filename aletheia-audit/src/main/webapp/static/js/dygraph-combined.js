...
DygraphLayout.prototype._evaluateLineCharts = function () {
    ...
    for (var f in this.datasets) {
        ...
        var c = this.dygraph_.axisPropertiesForSeries(f);
        for (var b = 0; b < e.length; b++) {
            ...
            var a = {x: ((parseFloat(d[0]) - this.minxval) * this.xscale), y: g, xval: parseFloat(d[0]), yval: parseFloat(d[1]), name: f};
            this.points.push(a)
        }
    }
};
...
DygraphCanvasRenderer.prototype.computeArea_ = function () {
    ...
    a.w = this.width - a.x - this.attr_("rightGap");
    a.h = this.height;
...
DygraphCanvasRenderer.prototype._renderAxis = function () {
    ...
    var c = this.elementContext;
    var k = {position: "absolute", fontSize: this.attr_("axisLabelFontSize") + "px", zIndex: 10, color: this.attr_("axisLabelColor"), width: this.attr_("axisLabelWidth") + "px", overflow: "hidden"};
    var g = function (i, t) {
        ...
        r.className = "dygraph-axis-label dygraph-axis-label-" + t;
        r.appendChild(document.createTextNode(i));
        u.appendChild(r);
        return u
    };
    c.save();
    c.strokeStyle = this.attr_("axisLineColor");
    c.lineWidth = this.attr_("axisLineWidth");
    if (this.attr_("drawYAxis")) {
        if (this.layout.yticks && this.layout.yticks.length > 0) {
            for (var h = 0; h < this.layout.yticks.length; h++) {
                ...
                c.beginPath();
                c.moveTo(b(o), e(m));
                c.lineTo(b(o - f * this.attr_("axisTickSize")), e(m));
                c.closePath();
                c.stroke();
                var n = g(j[2], "y");
                var l = (m - this.attr_("axisLabelFontSize") / 2);
                if (l < 0) {
                    l = 0
                }
                if (l + this.attr_("axisLabelFontSize") + 3 > this.height) {
                    n.style.bottom = "0px"
                } else {
                    n.style.top = l + "px"
                }
                if (j[0] == 0) {
                    n.style.left = (this.area.x - this.attr_("yAxisLabelWidth") - this.attr_("axisTickSize")) + "px";
                    n.style.textAlign = "right"
                } else {
                    if (j[0] == 1) {
                        n.style.left = (this.area.x + this.area.w + this.attr_("axisTickSize")) + "px";
                        n.style.textAlign = "left"
                    }
                }
                n.style.width = this.attr_("yAxisLabelWidth") + "px";
                this.container.appendChild(n);
                this.ylabels.push(n)
            }
            var p = this.ylabels[0];
            var q = this.attr_("axisLabelFontSize");
    ...
    if (this.attr_("drawXAxis")) {
        if (this.layout.xticks) {
            for (var h = 0; h < this.layout.xticks.length; h++) {
                ...
                c.beginPath();
                c.moveTo(b(o), e(m));
                c.lineTo(b(o), e(m + this.attr_("axisTickSize")));
                c.closePath();
                c.stroke();
                var n = g(j[1], "x");
                n.style.textAlign = "center";
                n.style.top = (m + this.attr_("axisTickSize")) + "px";
                var d = (o - this.attr_("axisLabelWidth") / 2);
                if (d + this.attr_("axisLabelWidth") > this.width) {
                    d = this.width - this.attr_("xAxisLabelWidth");
                    n.style.textAlign = "right"
                }
                if (d < 0) {
                    d = 0;
                ...
                n.style.left = d + "px";
                n.style.width = this.attr_("xAxisLabelWidth") + "px";
                this.container.appendChild(n);
                this.xlabels.push(n)
            }
        }
...
DygraphCanvasRenderer.prototype._renderChartLabels = function () {
    ...
    if (this.attr_("ylabel")) {
        var c = {left: 0, top: this.area.y, width: this.attr_("yLabelWidth"), height: this.area.h};
        var d = document.createElement("div");
        d.style.position = "absolute";
        d.style.left = c.left;
...
DygraphCanvasRenderer.prototype._renderLineChart = function () {
    ...
    var y = this.attr_("fillAlpha");
    var D = this.attr_("errorBars") || this.attr_("customBars");
    var r = this.attr_("fillGraph");
    var e = this.attr_("stackedGraph");
    var l = this.attr_("stepPlot");
    var F = [];
    for (var G in this.layout.datasets) {
        if (this.layout.datasets.hasOwnProperty(G)) {
            F.push(G)
        }
    }
    var z = F.length;
    this.colors = {};
    for (var B = 0; B < z; B++) {
        this.colors[F[B]] = this.colorScheme_[B % this.colorScheme_.length]
    }
    for (var B = 0; B < this.layout.points.length; B++) {
        var u = this.layout.points[B];
    ...
    if (D) {
        ...
        for (var B = 0; B < z; B++) {
            var h = F[B];
            var c = this.dygraph_.axisPropertiesForSeries(h);
            var w = this.colors[h];
            t.save();
            var k = NaN;
            var f = NaN;
            var g = [-1, -1];
            var C = c.yscale;
            var a = new RGBColor(w);
            var E = "rgba(" + a.r + "," + a.g + "," + a.b + "," + y + ")";
            t.fillStyle = E;
            t.beginPath();
            for (var x = 0; x < this.layout.points.length; x++) {
                var u = this.layout.points[x];
                if (u.name == h) {
                    if (!Dygraph.isOK(u.y)) {
                        k = NaN;
                        continue
                    ...
                    if (l) {
                        var p = [f - u.errorPlus * C, f + u.errorMinus * C];
                        f = u.y
                    } else {
                        var p = [u.y - u.errorPlus * C, u.y + u.errorMinus * C]
                    }
                    ...
                    if (!isNaN(k)) {
                        ...
                        t.lineTo(u.canvasx, p[0]);
                        t.lineTo(u.canvasx, p[1]);
                        if (l) {
                            t.lineTo(k, p[1])
                        } else {
                            t.lineTo(k, g[1])
    ...
    for (var B = 0; B < z; B++) {
        var h = F[B];
        var w = this.colors[h];
        var q = this.dygraph_.attr_("strokeWidth", h);
        d.save();
        var u = this.layout.points[0];
        var m = this.dygraph_.attr_("pointSize", h);
        var k = null, f = null;
        var v = this.dygraph_.attr_("drawPoints", h);
            ...
            if (u.name == h) {
                if (s(u.canvasy)) {
                    if (l && k != null) {
                        t.beginPath();
                        t.strokeStyle = w;
                        t.lineWidth = this.attr_("strokeWidth");
                        t.moveTo(k, f);
                        t.lineTo(u.canvasx, f);
                        t.stroke()
                    }
                    k = f = null
                } else {
                    var n = (!k && (x == A.length - 1 || s(A[x + 1].canvasy)));
                    if (k === null) {
                        k = u.canvasx;
                        f = u.canvasy
                    } else {
                    ...
                    if (v || n) {
                        t.beginPath();
                        t.fillStyle = w;
                        t.arc(u.canvasx, u.canvasy, m, 0, 2 * Math.PI, false);
                        t.fill()
                    }
                }
            }
...
Dygraph.DEFAULT_ATTRS = {highlightCircleSize: 3, pixelsPerXLabel: 60, pixelsPerYLabel: 30, labelsDivWidth: 250, labelsDivStyles: {}, labelsSeparateLines: false, labelsShowZeroValues: true, labelsKMB: false, labelsKMG2: false, showLabelsOnHighlight: true, yValueFormatter: function (d, c) {
    return Dygraph.numberFormatter(d, c)
}, digitsAfterDecimal: 2, maxNumberWidth: 6, sigFigs: null, strokeWidth: 1, axisTickSize: 3, axisLabelFontSize: 14, xAxisLabelWidth: 50, yAxisLabelWidth: 50, xAxisLabelFormatter: Dygraph.dateAxisFormatter, rightGap: 5, showRoller: false, xValueFormatter: Dygraph.dateString_, xValueParser: Dygraph.dateParser, xTicker: Dygraph.dateTicker, delimiter: ",", sigma: 2, errorBars: false, fractions: false, wilsonInterval: true, customBars: false, fillGraph: false, fillAlpha: 0.15, connectSeparatedPoints: false, stackedGraph: false, hideOverlayOnMouseOut: true, legend: "onmouseover", stepPlot: false, avoidMinZero: false, titleHeight: 28, xLabelHeight: 18, yLabelWidth: 18, drawXAxis: true, drawYAxis: true, axisLineColor: "black", axisLineWidth: 0.3, gridLineWidth: 0.3, axisLabelColor: "black", axisLabelFont: "Arial", axisLabelWidth: 50, drawYGrid: true, drawXGrid: true, gridLineColor: "rgb(128,128,128)", interactionModel: null};
Dygraph.DEBUG = 1;
Dygraph.INFO = 2;
Dygraph.WARNING = 3;
Dygraph.ERROR = 3;
...
Dygraph.Interaction.endZoom = function (b, j, e) {
    e.isZooming = false;
    ...
    if (f >= 10 && e.dragDirection == Dygraph.HORIZONTAL) {
        ...
        if (d >= 10 && e.dragDirection == Dygraph.VERTICAL) {
            ...
            j.canvas_ctx_.clearRect(0, 0, j.canvas_.width, j.canvas_.height)
        }
    }
    e.dragStartX = null;
    e.dragStartY = null
...
Dygraph.prototype.generateLegendHTML_ = function (j, k) {
    if (typeof(j) === "undefined") {
        if (this.attr_("legend") != "always") {
            return""
        }
        var a = this.attr_("labelsSeparateLines");
        ...
        for (var d = 1; d < f.length; d++) {
            ...
            var h = this.plotter_.colors[f[d]];
            if (e != "") {
                e += (a ? "<br/>" : " ")
            }
            e += "<b><span style='color: " + h + ";'>&mdash;" + f[d] + "</span></b>"
        }
        return e
    }
    var e = this.attr_("xValueFormatter")(j) + ":";
    var b = this.attr_("yValueFormatter");
    var l = this.attr_("labelsShowZeroValues");
    var a = this.attr_("labelsSeparateLines");
    for (var d = 0; d < this.selPoints_.length; d++) {
        var m = this.selPoints_[d];
        if (m.yval == 0 && !l) {
            continue
        }
        if (!Dygraph.isOK(m.canvasy)) {
            continue
        }
        if (a) {
            e += "<br/>"
        }
        var h = this.plotter_.colors[m.name];
        var g = b(m.yval, this);
        e += " <b><span style='color: " + h + ";'>" + m.name + "</span></b>:" + g
    }
    return e
};
...
Dygraph.numberFormatter = function (a, d) {
    var b = d.attr_("sigFigs");
    if (b !== null) {
        return Dygraph.floatFormat(a, b)
    }
    var e = d.attr_("digitsAfterDecimal");
    var c = d.attr_("maxNumberWidth");
    if (a !== 0 && (Math.abs(a) >= Math.pow(10, c) || Math.abs(a) < Math.pow(10, -e))) {
        return a.toExponential(e)
    } else {
        return"" + Dygraph.round_(a, e)
    }
};
...
Dygraph.prototype.addXTicks_ = function () {
    ...
    var b = this.attr_("xTicker")(a[0], a[1], this);
...
Dygraph.prototype.GetXAxis = function (m, h, a) {
    ...
    if (a < Dygraph.MONTHLY) {
        ...
        m = w.getTime();
        for (var k = m; k <= h; k += c) {
            y.push({v: k, label: r(new Date(k), a)})
        }
    } else {
        var e;
        var n = 1;
...
Dygraph.numericTicks = function (G, F, s, c, m) {
    var w = function (i) {
    ...
    if (m) {
        ...
        if (c && w("logscale")) {
            ...
            var y = Math.floor(s.height_ / r);
            var g = Dygraph.binarySearch(G, Dygraph.PREFERRED_LOG_TICK_VALUES, 1);
            var I = Dygraph.binarySearch(F, Dygraph.PREFERRED_LOG_TICK_VALUES, -1);
            if (g == -1) {
                g = 0
            }
            if (I == -1) {
                I = Dygraph.PREFERRED_LOG_TICK_VALUES.length - 1
            }
            var q = null;
            if (I - g >= y / 4) {
                var E = c.yAxisId;
                for (var p = I; p >= g; p--) {
                    ...
                    var t = c.g.toDomYCoord(h, E);
                    var D = {v: h};
                    if (q == null) {
                        q = {tickValue: h, domCoord: t}
                    } else {
                        if (t - q.domCoord >= r) {
                            q = {tickValue: h, domCoord: t}
                        } else {
    ...
    var B = w("yAxisLabelFormatter") ? w("yAxisLabelFormatter") : w("yValueFormatter");
    for (var C = 0; C < H.length; C++) {
        if (H[C].label !== undefined) {
            continue
        }
        var o = H[C].v;
        var b = Math.abs(o);
        ...
        if (v.length > 0) {
            var u = z * z * z * z;
            for (var A = 3; A >= 0; A--, u /= z) {
                if (b >= u) {
                    f = Dygraph.round_(o / u, w("digitsAfterDecimal")) + v[A];
                    break
                }
            }
        }
...
Dygraph.prototype.computeYAxes_ = function () {
    ...
    for (var j in f) {
        ...
        if (typeof(c) == "object") {
            ...
            var n = this.axes_.length;
            a.yAxisId = n;
            a.g = this;
            Dygraph.update(a, c);
            this.axes_.push(a);
            this.seriesToAxisMap_[j] = n
        }
    }
    for (var j in f) {
        if (!f.hasOwnProperty(j)) {
...
Dygraph.prototype.updateOptions = function (b, a) {
    if (typeof(a) == "undefined") {
        a = false
    }
    if ("rollPeriod" in b) {
        this.rollPeriod_ = b.rollPeriod
    }
    if ("dateWindow" in b) {
        this.dateWindow_ = b.dateWindow;
        if (!("isZoomedIgnoreProgrammaticZoom" in b)) {
            this.zoomed_x_ = b.dateWindow != null
        }
    }
    if ("valueRange" in b && !("isZoomedIgnoreProgrammaticZoom" in b)) {
        this.zoomed_y_ = b.valueRange != null
    }
    Dygraph.update(this.user_attrs_, b);
    if (b.file) {
        this.file_ = b.file;
